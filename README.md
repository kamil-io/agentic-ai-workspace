...
See the [company agent organisation](docs/agent-organisation.md) for the proposed chart, confirmed names and role boundaries: Ahmad_ceo_bot as CEO, ak.kamil as Pekebun Data (Developer & Farmer), Fahmi_bot for operations, Alan_bot for sales and customer care, Hafeez_bot for marketing and content, Azri_bot for delivery and automation, Man_bot for finance and Salleh_bot for security. Runtime migrations remain pending.
